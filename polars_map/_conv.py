...
def _apply_array(inner_expr: pl.Expr, width: int, expr: pl.Expr) -> pl.Expr:
    ...
    # list instead, which is not _free_
    # TODO submit an issue to polars to fix this and drop the workaround
...
def _to_map(key_conv: ToConv | None, val_conv: ToConv | None, arr: Array) -> Array:
    ...
    # Arrow maps only use int32 offsets, drop when LargeMap is added
    # TODO submit issue about LargeMap
